          ...
          <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
            <div class="images-row">
              <?php 
                ...
                $fetchBooks = $this->db->query("SELECT * FROM book_directory WHERE category = 'Foundations' ORDER BY RAND() LIMIT 3");
          ...
          <div class="row">
            <div class="col-xxl-12">
              <div class="row">
                 ...
                 <?php 
            $fetchFoundationCategory = $this->db->query("SELECT * FROM book_directory WHERE category='Foundations'");
            foreach ($fetchFoundationCategory->result() as $row){ ?> 
