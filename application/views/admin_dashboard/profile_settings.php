                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="card-wrapper border rounded-3">
                      ...
                      <form class="row g-3" method="POST" action="<?php echo base_url('updateAdminPassword'); ?>">
                        ...
                        <div class="col-12">
                          <button class="btn btn-primary" type="submit" name="updateProfilePassword">Update Details </button>
                        </div>
                      </form>
                    </div>
                  </div>
