...
<h4 class="f-w-600">Welcome <?php echo $adminName; ?></h4><img class="mt-0" src="<?php echo base_url(); ?>modules/dashboard/assets/images/hand.gif" alt="hand-gif">
</div>
</div>
...
</svg><span class="badge rounded-pill badge-secondary">7</span>
</div>
...
<li class="nav-item p-0"> <a class="nav-link active" id="pills-blog-tab" data-bs-toggle="pill" href="#pills-blog" role="tab" aria-controls="pills-aboutus" aria-selected="true">Messages</a></li>
</ul>

<div class="tab-content" id="pills-blog-tab">
<div class="tab-pane fade show active" id="pills-blog-tab" role="tabpanel" aria-labelledby="pills-blog-tab">
...
<div class="media profile-media"><img class="b-r-10" src="<?php echo $adminAvatar; ?>" alt="" style="width: 45px;">
<div class="media-body d-xxl-block d-none box-col-none">
<div class="d-flex align-items-center gap-2"> <span><?php echo $adminName; ?></span><i class="middle fa fa-angle-down"> </i></div>
<p class="mb-0 font-roboto"><?php echo $adminUID; ?></p>
</div>
</div>
<ul class="profile-dropdown onhover-show-div">
<li><a href="<?php echo base_url('profile_mgmt'); ?>"><i data-feather="user"></i><span>My Profile</span></a></li>
<!-- <li><a href="letter-box.html"><i data-feather="mail"></i><span>Inbox</span></a></li> -->
<li> <a href="<?php echo base_url('profile_settings'); ?>"> <i data-feather="settings"></i><span>Settings</span></a></li>
<li><a class="btn btn-pill btn-outline-primary btn-sm" href="<?php echo base_url('checkoutAdmin'); ?>">Log Out</a></li>
</ul>
</li>
</ul>
</div>
