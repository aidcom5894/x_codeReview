...
<h4 class="f-w-600">Welcome <?php echo $parentname; ?></h4><img class="mt-0" src="<?php echo base_url(); ?>modules/dashboard/assets/images/hand.gif" alt="hand-gif">
</div>
</div>
<div class="welcome-content d-xl-block d-none"><span class="text-truncate col-12">Here’s what’s happening with your bookstore today. </span></div>
</div>
...
<div class="media profile-media"><img class="b-r-10" src="<?php echo $parentImage; ?>" alt="" style="width: 35px; height: 35px;">
<div class="media-body d-xxl-block d-none box-col-none">
<div class="d-flex align-items-center gap-2"> <span><?php echo $parentname; ?> </span><i class="middle fa fa-angle-down"> </i></div>
<p class="mb-0 font-roboto"><?php echo $parentuid; ?></p>
</div>
</div>
<ul class="profile-dropdown onhover-show-div">
<li><a href="<?php echo base_url('edit_user_profile'); ?>"><i data-feather="user"></i><span>My Profile</span></a></li>
<!-- <li><a href="#"><i data-feather="mail"></i><span>Inbox</span></a></li> -->
<li> <a href="<?php echo base_url('password_mgmt'); ?>"> <i data-feather="settings"></i><span>Settings</span></a></li>
<li><a class="btn btn-pill btn-outline-primary btn-sm" href="<?php echo base_url('user_logout'); ?>">Log Out</a></li>
</ul>
</li>
</ul>
</div>
