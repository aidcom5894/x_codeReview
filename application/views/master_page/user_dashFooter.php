...
<p class="mb-0">Copyright <?php echo date('Y
  '). " &copy;"; ?> Developed with &hearts; By <a href="https://pandittechnology.com/" target="_blank">Pandit Technology & Solutions</a> </p>
</div>
</div>
</div>
</footer>
...
<!-- <script src="<?php echo base_url(); ?>modules/dashboard/assets/js/theme-customizer/customizer.js"></script> -->
